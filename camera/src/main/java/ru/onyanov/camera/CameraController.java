...
import ru.onyanov.camera.plugin.FlashModePlugin;
import ru.onyanov.camera.plugin.FocusModePlugin;
import ru.onyanov.camera.plugin.OrientationPlugin;
import ru.onyanov.camera.plugin.SizeAndFormatPlugin;
